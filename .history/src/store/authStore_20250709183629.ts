    ...
    (set, get) => ({
      ...
      signIn: async (email: string, password: string) => {
        ...
        try {
          ...
          set({ isLoading: false });
          return { success: false, error: error && error.message ? error.message : 'Authentication failed' };
        } catch (error: any) {
          set({ isLoading: false });
          return { success: false, error: error && error.message ? error.message : 'An unexpected error occurred' };
        }
      ...
      signUp: async (email: string, password: string, firstName: string, lastName: string) => {
        ...
        try {
          ...
          set({ isLoading: false });
          set({ isLoading: false });
          return { success: false, error: error && error.message ? error.message : 'Registration failed' };
        } catch (error: any) {
          set({ isLoading: false });
          console.error('Sign in error:', error);
          set({ isLoading: false });
